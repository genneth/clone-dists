...
\begin{align*}
\beta &= \frac{\left(1-e^{-\Delta \lambda t}\right)(1-\delta)+2\delta}{2\delta}.
\end{align*}
The clone size distribution is:
\begin{equation*}
P_m(t) = \begin{cases}
1 - \frac{e^{-\Delta \lambda t}}{\beta} & m=0 \\
\frac{e^{-\Delta \lambda t}}{\beta} \frac{1}{\beta-1} \left(1-\frac{1}{\beta}\right)^m & m\ge1
\end{cases}
\end{equation*}
