...
rhos = linspace(0.01, 0.99, 50);
rs = linspace(0.01, 0.49, 51);
lambdas = linspace(0.5, 1.0, 32); % around 0.77/week

infer_eyp(rhos, rs, lambdas, [t1], {data1}, 'oes-eyp-b-day-3');
infer_eyp(rhos, rs, lambdas, [t2], {data2}, 'oes-eyp-b-day-10');
infer_eyp(rhos, rs, lambdas, [t3], {data3}, 'oes-eyp-b-week-3');
infer_eyp(rhos, rs, lambdas, [t4], {data4}, 'oes-eyp-b-week-6');
infer_eyp(rhos, rs, lambdas, [t5], {data5}, 'oes-eyp-b-week-12');
infer_eyp(rhos, rs, lambdas, [t6 t6], {data6a data6b}, 'oes-eyp-b-week-26');
infer_eyp(rhos, rs, lambdas, [t7 t7], {data7a data7b}, 'oes-eyp-b-week-52');
